...
#     print(lineList[i], '+++++++++++++++++++++++++++++++++++++')
for i in range(idxSGDStart, idxSGDEnd):    
    if 'Circuit 1' in lineList[i] or 'Circuit 2' in lineList[i]:
        if countOccurrences(lineList[i], 'Circuit') > 1 :
            ...
            for j in range(0, len(CircuitlineList)):
                ...
                if '.wir' in CircuitlineList[j]:
                    ...
                    # print(len(updatedSplitText), 'LEEEEEEEEEEEEEEEEEEEN')
                    # print(updatedSplitText[0])
                    # print(updatedSplitText[1])
                    # print(updatedSplitText[2])
                    # print(updatedSplitText[3])
                    # print(updatedSplitText[4])
                    # print(updatedSplitText[5])
                    # print(updatedSplitText[6])
                    # print(updatedSplitText[7])
                    # print(updatedSplitText[8])
                    # print(updatedSplitText[9])
                    # print(updatedSplitText[10])
                    # print(updatedSplitText[11])
                    # print('++++++++++++++++++++++++++++++++++++')
                    
                    if '.wir' or '.Wir' in updatedSplitText[4]:
